				 ...
				 
{
  ...
  out.println("<script>alert('Academic Details Added...!')</script>");
...
%>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Academic Year</span></h2><br>
          <form action="academicstudent.jsp">
		  <table width="300">
			<tr>
			<td>
...
<font size="3" color="#000000"><b>Year<td><select name="year">
	...
	<option value="1" >I
		<option value="2" >II
			...
			<tr align="left"><td><br><br><input type="submit" value="submit"></td></tr>
			</table>
		  </form>
